...
namespace Oculus.Interaction.UnityCanvas
{
    ...
    public class CanvasRenderTexture : MonoBehaviour
    {
        ...
        protected void Start()
        {
            ...
            //EventDispatcher.instance.AddEventHandler((int)NHR.EventType.eEventType.Update_CurvedUI, new EventHandler((type) =>
            //{
            //    Debug.Log("update curvedUI");
            //    UpdateCamera();
            //}));
