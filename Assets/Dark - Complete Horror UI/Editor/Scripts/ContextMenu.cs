...
namespace Michsky.UI.Dark
{
    public class ContextMenu : Editor
    {
        ...
        [MenuItem("GameObject/Dark UI/Title Button", false, 0)]
        static void UIEMB()
        {
            CreateObject("UI Elements/Title Button");
        }

        [MenuItem("GameObject/Dark UI/Title Button (Free)", false, 0)]
        static void UIEMBF()
        {
            CreateObject("UI Elements/Title Button (Free)");
        }
